...
public class ShaderFilterType {
    ...
    public static final int FILTER_ARTIST = 0x12;
    public static final int FILTER_VANGOGH = 0x13;
    public static final int FILTER_MONET = 0x14;
    public static final int FILTER_PICASSO = 0x15;
    public static final int FILTER_REFLECTION = 0x16;
    public static final int FILTER_PATTERN = 0x17;
    public static final int FILTER_BLUR = 0x18;
    public static final int FILTER_BEAUTY = 0x19;
